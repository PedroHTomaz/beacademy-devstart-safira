    ...
    <table class="table table-striped">
        ...
        <tbody>
           <tr>
                ...
                <td><img src="{{asset('https://teste-laravel9.s3.sa-east-1.amazonaws.com/' . $products->photo)}}" width="50" height="50" class="border border-primary border-3 rounded-circle"></td>
