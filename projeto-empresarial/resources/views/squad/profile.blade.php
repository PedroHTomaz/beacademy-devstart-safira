                ...
                <div class="devCard card px-3 border-0">
                    <div class="pic mx-auto m-3 border border-5 border-primary rounded-circle">
                        <img data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Estudante autodidata de desenvolvimento web,
                             ...
                             src="https://media-exp1.licdn.com/dms/image/C4E03AQHRDwfpbcS_5A/profile-displayphoto-shrink_200_200/0/1646874316861?e=1664409600&v=beta&t=FbbVyjvSCcUzpqu-OCyPQJYa3a4Isqm-GKx3aVo6RoY">
                    </div>
                ...
                <div class="devCard card px-3 border-0">
                    <div class="pic mx-auto m-3 border border-5 border-primary rounded-circle">
                        <img data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                                                                                sed do eiusmod tempor incididunt ut labore et dolore magna aliqua"
                             class="h-100 border border-5 border-light card-img-top rounded-circle"
                             src="https://media-exp1.licdn.com/dms/image/C4E03AQGTUPCJnjqXrQ/profile-displayphoto-shrink_200_200/0/1630168471539?e=1664409600&v=beta&t=Vxl0hAKxuUMEu-lzZPu2jiisQIEnoTfAMSffmS6NcSw">
                    </div>
                    <div class="card-body text-center">
                ...
                <div class="devCard card px-3 border-0">
                    <div class="pic mx-auto m-3 border border-5 border-primary rounded-circle">
                        <img data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                                                                                sed do eiusmod tempor incididunt ut labore et dolore magna aliqua"
                             class="h-100 border border-5 border-light card-img-top rounded-circle"
                             src="https://media-exp1.licdn.com/dms/image/C4D03AQFmHFR_PRmPdg/profile-displayphoto-shrink_200_200/0/1567619932909?e=1664409600&v=beta&t=RPMQjnWFS3qBqxNdd0HPdkDJa45SjWJhkZHigM9TL3k">
                    </div>
                    <div class="card-body text-center">
